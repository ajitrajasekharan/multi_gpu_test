...
function step4
{
	sudo apt install python3-pip; pip3 install torchvision;  pip install pytorch_transformers; pip3 install seqeval; pip3 install tqdm; pip3 install nltk; pip install tensorboardX;
